...
**
** Created: Mon Apr 29 14:28:19 2013
...
public:
    ...
    QLabel *label_8;
    QLCDNumber *compass_LCD_x;
    QLabel *label_10;
    QLCDNumber *compass_LCD_y;
    QLabel *label_11;
    QLCDNumber *compass_LCD_z;
    QSpacerItem *horizontalSpacer_3;
    QGridLayout *gridLayout_2;
    QLabel *acceleration_label;
    QLabel *label_12;
    QLCDNumber *accelerometer_LCD_x;
    QLabel *label_13;
    QLCDNumber *accelerometer_LCD_y;
    QLabel *label_14;
    QLCDNumber *accelerometer_LCD_z;
    ...
    QLabel *label_19;
    QLabel *label_18;
    QLCDNumber *IR_front_LCD;
    QLabel *label_20;
    QLCDNumber *IR_left_LCD;
    QLCDNumber *IR_right_LCD;
    QLabel *label_22;
    QLCDNumber *IR_back_LCD;
    QFrame *line_3;
    ...
    QLabel *ioio_port_label_2;
    QLineEdit *NN_port_lineEdit;
    QLabel *nn_label;
    ...
    void setupUi(QDialog *Android_Dialog)
    {
        ...
        Android_Dialog->resize(1118, 660);
        verticalLayout_15 = new QVBoxLayout(Android_Dialog);
        ...
        img_compression_Slider->setValue(50);
        img_compression_Slider->setSliderPosition(50);
        ...
        video_label->setMinimumSize(QSize(50, 50));
        ...
        verticalSpacer_3 = new QSpacerItem(13, 98, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        compass_label = new QLabel(Android_Dialog);
        compass_label->setObjectName(QString::fromUtf8("compass_label"));
        QFont font1;
        font1.setPointSize(12);
        compass_label->setFont(font1);
        compass_label->setAlignment(Qt::AlignCenter);

        gridLayout->addWidget(compass_label, 0, 0, 1, 2);

        label_8 = new QLabel(Android_Dialog);
        label_8->setObjectName(QString::fromUtf8("label_8"));

        gridLayout->addWidget(label_8, 1, 0, 1, 1);

        compass_LCD_x = new QLCDNumber(Android_Dialog);
        compass_LCD_x->setObjectName(QString::fromUtf8("compass_LCD_x"));
        compass_LCD_x->setSegmentStyle(QLCDNumber::Flat);

        gridLayout->addWidget(compass_LCD_x, 1, 1, 1, 1);

        label_10 = new QLabel(Android_Dialog);
        label_10->setObjectName(QString::fromUtf8("label_10"));

        gridLayout->addWidget(label_10, 2, 0, 1, 1);

        compass_LCD_y = new QLCDNumber(Android_Dialog);
        compass_LCD_y->setObjectName(QString::fromUtf8("compass_LCD_y"));
        compass_LCD_y->setSegmentStyle(QLCDNumber::Flat);

        gridLayout->addWidget(compass_LCD_y, 2, 1, 1, 1);

        label_11 = new QLabel(Android_Dialog);
        label_11->setObjectName(QString::fromUtf8("label_11"));

        gridLayout->addWidget(label_11, 3, 0, 1, 1);

        compass_LCD_z = new QLCDNumber(Android_Dialog);
        compass_LCD_z->setObjectName(QString::fromUtf8("compass_LCD_z"));
        compass_LCD_z->setSegmentStyle(QLCDNumber::Flat);

        gridLayout->addWidget(compass_LCD_z, 3, 1, 1, 1);
        ...
        acceleration_label = new QLabel(Android_Dialog);
        acceleration_label->setObjectName(QString::fromUtf8("acceleration_label"));
        acceleration_label->setFont(font1);
        acceleration_label->setAlignment(Qt::AlignCenter);

        gridLayout_2->addWidget(acceleration_label, 0, 0, 1, 2);

        label_12 = new QLabel(Android_Dialog);
        label_12->setObjectName(QString::fromUtf8("label_12"));

        gridLayout_2->addWidget(label_12, 1, 0, 1, 1);

        accelerometer_LCD_x = new QLCDNumber(Android_Dialog);
        accelerometer_LCD_x->setObjectName(QString::fromUtf8("accelerometer_LCD_x"));
        accelerometer_LCD_x->setSegmentStyle(QLCDNumber::Flat);

        gridLayout_2->addWidget(accelerometer_LCD_x, 1, 1, 1, 1);

        label_13 = new QLabel(Android_Dialog);
        label_13->setObjectName(QString::fromUtf8("label_13"));

        gridLayout_2->addWidget(label_13, 2, 0, 1, 1);

        accelerometer_LCD_y = new QLCDNumber(Android_Dialog);
        accelerometer_LCD_y->setObjectName(QString::fromUtf8("accelerometer_LCD_y"));
        accelerometer_LCD_y->setSegmentStyle(QLCDNumber::Flat);

        gridLayout_2->addWidget(accelerometer_LCD_y, 2, 1, 1, 1);

        label_14 = new QLabel(Android_Dialog);
        label_14->setObjectName(QString::fromUtf8("label_14"));

        gridLayout_2->addWidget(label_14, 3, 0, 1, 1);

        accelerometer_LCD_z = new QLCDNumber(Android_Dialog);
        accelerometer_LCD_z->setObjectName(QString::fromUtf8("accelerometer_LCD_z"));
        accelerometer_LCD_z->setSegmentStyle(QLCDNumber::Flat);

        gridLayout_2->addWidget(accelerometer_LCD_z, 3, 1, 1, 1);
        ...
        ioio_checkBox = new QCheckBox(Android_Dialog);
        ioio_checkBox->setObjectName(QString::fromUtf8("ioio_checkBox"));
        ioio_checkBox->setChecked(true);

        verticalLayout_9->addWidget(ioio_checkBox);
        ...
        verticalSpacer_10 = new QSpacerItem(203, 13, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        verticalSpacer_8 = new QSpacerItem(203, 13, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        verticalSpacer_7 = new QSpacerItem(203, 13, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayout_13->addItem(verticalSpacer_7);

        ioio_label = new QLabel(Android_Dialog);
        ioio_label->setObjectName(QString::fromUtf8("ioio_label"));
        ioio_label->setFont(font1);
        ioio_label->setAlignment(Qt::AlignCenter);

        verticalLayout_13->addWidget(ioio_label);

        gridLayout_3 = new QGridLayout();
        gridLayout_3->setObjectName(QString::fromUtf8("gridLayout_3"));
        label_19 = new QLabel(Android_Dialog);
        ...
        label_18 = new QLabel(Android_Dialog);
        ...
        IR_front_LCD = new QLCDNumber(Android_Dialog);
        IR_front_LCD->setObjectName(QString::fromUtf8("IR_front_LCD"));
        IR_front_LCD->setSegmentStyle(QLCDNumber::Flat);

        gridLayout_3->addWidget(IR_front_LCD, 1, 1, 1, 1);

        label_20 = new QLabel(Android_Dialog);
        ...
        IR_left_LCD = new QLCDNumber(Android_Dialog);
        IR_left_LCD->setObjectName(QString::fromUtf8("IR_left_LCD"));
        IR_left_LCD->setSegmentStyle(QLCDNumber::Flat);

        gridLayout_3->addWidget(IR_left_LCD, 2, 0, 1, 1);

        IR_right_LCD = new QLCDNumber(Android_Dialog);
        IR_right_LCD->setObjectName(QString::fromUtf8("IR_right_LCD"));
        IR_right_LCD->setSegmentStyle(QLCDNumber::Flat);

        gridLayout_3->addWidget(IR_right_LCD, 2, 2, 1, 1);

        label_22 = new QLabel(Android_Dialog);
        label_22->setObjectName(QString::fromUtf8("label_22"));
        label_22->setLayoutDirection(Qt::LeftToRight);
        label_22->setAlignment(Qt::AlignCenter);

        gridLayout_3->addWidget(label_22, 4, 1, 1, 1);

        IR_back_LCD = new QLCDNumber(Android_Dialog);
        IR_back_LCD->setObjectName(QString::fromUtf8("IR_back_LCD"));
        IR_back_LCD->setSegmentStyle(QLCDNumber::Flat);

        gridLayout_3->addWidget(IR_back_LCD, 5, 1, 1, 1);
        ...
        line_3 = new QFrame(Android_Dialog);
        ...
        label_26 = new QLabel(Android_Dialog);
        ...
        start_exp_btn = new QPushButton(Android_Dialog);
        start_exp_btn->setObjectName(QString::fromUtf8("start_exp_btn"));

        horizontalLayout_4->addWidget(start_exp_btn);

        stop_exp_btn = new QPushButton(Android_Dialog);
        stop_exp_btn->setObjectName(QString::fromUtf8("stop_exp_btn"));

        horizontalLayout_4->addWidget(stop_exp_btn);
        ...
        ioio_port_label_2 = new QLabel(Android_Dialog);
        ioio_port_label_2->setObjectName(QString::fromUtf8("ioio_port_label_2"));

        horizontalLayout_22->addWidget(ioio_port_label_2);

        NN_port_lineEdit = new QLineEdit(Android_Dialog);
        NN_port_lineEdit->setObjectName(QString::fromUtf8("NN_port_lineEdit"));
        NN_port_lineEdit->setEnabled(false);
        sizePolicy.setHeightForWidth(NN_port_lineEdit->sizePolicy().hasHeightForWidth());
        NN_port_lineEdit->setSizePolicy(sizePolicy);
        NN_port_lineEdit->setMaximumSize(QSize(50, 16777215));
        NN_port_lineEdit->setMaxLength(6);

        horizontalLayout_22->addWidget(NN_port_lineEdit);


        verticalLayout_14->addLayout(horizontalLayout_22);

        nn_label = new QLabel(Android_Dialog);
        nn_label->setObjectName(QString::fromUtf8("nn_label"));
        nn_label->setMinimumSize(QSize(300, 500));
        QFont font2;
        ...
        nn_label->setFont(font2);
        nn_label->setFrameShape(QFrame::Panel);
        nn_label->setFrameShadow(QFrame::Sunken);

        verticalLayout_14->addWidget(nn_label);
    ...
    void retranslateUi(QDialog *Android_Dialog)
    {
        ...
        compr_rate_label->setText(QApplication::translate("Android_Dialog", "50", 0, QApplication::UnicodeUTF8));
        ...
        compass_label->setText(QApplication::translate("Android_Dialog", "Compass", 0, QApplication::UnicodeUTF8));
        label_8->setText(QApplication::translate("Android_Dialog", "x:", 0, QApplication::UnicodeUTF8));
        label_10->setText(QApplication::translate("Android_Dialog", "y:", 0, QApplication::UnicodeUTF8));
        label_11->setText(QApplication::translate("Android_Dialog", "z:", 0, QApplication::UnicodeUTF8));
        acceleration_label->setText(QApplication::translate("Android_Dialog", "Acceleration", 0, QApplication::UnicodeUTF8));
        label_12->setText(QApplication::translate("Android_Dialog", "x:", 0, QApplication::UnicodeUTF8));
        label_13->setText(QApplication::translate("Android_Dialog", "y:", 0, QApplication::UnicodeUTF8));
        label_14->setText(QApplication::translate("Android_Dialog", "z:", 0, QApplication::UnicodeUTF8));
        ...
        ioio_checkBox->setText(QApplication::translate("Android_Dialog", "Inverted", 0, QApplication::UnicodeUTF8));
        ...
        ioio_label->setText(QApplication::translate("Android_Dialog", "IR sensors", 0, QApplication::UnicodeUTF8));
        label_19->setText(QApplication::translate("Android_Dialog", "FRONT", 0, QApplication::UnicodeUTF8));
        label_18->setText(QApplication::translate("Android_Dialog", "LEFT", 0, QApplication::UnicodeUTF8));
        label_20->setText(QApplication::translate("Android_Dialog", "RIGHT", 0, QApplication::UnicodeUTF8));
        label_22->setText(QApplication::translate("Android_Dialog", "BACK", 0, QApplication::UnicodeUTF8));
        label_26->setText(QApplication::translate("Android_Dialog", "NN", 0, QApplication::UnicodeUTF8));
        start_exp_btn->setText(QApplication::translate("Android_Dialog", "Start Experiment", 0, QApplication::UnicodeUTF8));
        stop_exp_btn->setText(QApplication::translate("Android_Dialog", "Stop Experiment", 0, QApplication::UnicodeUTF8));
        ioio_port_label_2->setText(QApplication::translate("Android_Dialog", "Port:", 0, QApplication::UnicodeUTF8));
        nn_label->setText(QApplication::translate("Android_Dialog", "ativity", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
